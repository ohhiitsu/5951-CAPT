...
import { doc, collection, setDoc, getDocs, updateDoc, deleteDoc } from "firebase/firestore";
    ...
    return (
        <div>
            ...
            <Popup open={openUpload} onClose={closeUploadModal}>
                ...
                {uploaded && <p className="success-msg">New Product was uploaded successfully</p>}
            </Popup>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    {products.map((product) => (
                        <tr key={product.id}>
                            ...
                            <td>
                                <button onClick={() => handleEditPrice(product.id, prompt('Enter new price:'))}>
                                    <EditIcon />
                                </button> </td>
                            <td>{product.quantity}</td>
                            <td>  <button onClick={() => handleEditQuantity(product.id, prompt('Enter new quantity:'))}>
                                <EditIcon />
                            </button></td>
                            <td><button onClick={() => handleDeleteProduct(product.id)}>
                                <DeleteIcon />
                            </button>
                            </td>
                        </tr>
